    ...
    <div>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div>
          ...
          <input type="text" id="account-number" v-model="form.accountNumber" />
        </div>
        <div>
          <label for="course">Course:</label>
          <input type="text" id="course" v-model="form.course" />
        </div>
        <div>
      ...
      <form @submit.prevent="submitForm">
        ...
        <div style="position: relative;">
          ...
          <input type="text" id="email-recovery" required v-model="form.emailRecovery" />
